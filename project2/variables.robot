...
${back_btn}    //div[@class="dc-form-submit-button account-closure-warning-modal__close-account-button dc-form-submit-button--relative"]//button[@class="dc-btn dc-btn__effect dc-btn--secondary dc-btn__large"]
${cloce_acc}    //div[@class="dc-form-submit-button account-closure-warning-modal__close-account-button dc-form-submit-button--relative"]//button[@class="dc-btn dc-btn__effect dc-btn--primary dc-btn__large"]
...
${cancel_btn}    //button[@id="btnCancel"]
${login_btn_2}    //button[@id="dt_login_button"]
